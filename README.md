...
The server will preview your changes and refresh the components as you do changes.

Before commiting, you should run the linters, just in case you missed something:

```shell
npm run lint
```

In the end you can build and export all the required files to the `out` directoy using:
